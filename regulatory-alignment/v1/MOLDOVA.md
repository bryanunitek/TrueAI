# Moldova — National AI Framework

How the public corpus aligns with Moldova's AI regulatory framework
including EU candidate alignment, the National Programme for AI Development, Law 133/2011 on Personal Data Protection, and sector frameworks.

## The law

### 1. National AI strategy

- **National Programme for AI Development (in development)**.

### 2. Data protection layer

- **Law 133 of 8 July 2011 on Personal Data Protection**.
- **ANPDCP (National Centre for Personal Data Protection)** — supervisory authority.

### 3. Cybersecurity layer

- **Cybersecurity Strategy 2023-2027**.
- **Moldovan CERT**.

### 4. Sector-specific frameworks

- **Banca Naţională a Moldovei (BNM)** — financial sector AI.
- **Medicines Agency** — AI medical devices.

### 5. Equality framework

- **Law on Ensuring Equality + Equality Council**.
...
1. Moldova has no AI-specific horizontal law yet (strategy/policy
...
- ANPDCP: https://datepersonale.md/
- Law 133/2011: https://www.legis.md/
- BNM: https://www.bnm.md/
