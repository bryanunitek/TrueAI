# Latvia — National AI Framework

How the public corpus aligns with Latvia's AI regulatory framework
including the EU AI Act (directly applicable), the national AI strategy,
Data State Inspectorate (DVI) oversight, and sector frameworks.
...
- **AI Strategy (Mākslīgā intelekta attīstības stratēģija)**.
- Latvia digital transformation framework.

### 3. Data protection layer

- **PDP Law 2018** — implements GDPR.
- **Data State Inspectorate (DVI)** — supervisory authority.
...
- **Latvijas Banka** — financial sector AI; aligned with EBA/EIOPA/ESMA.
- **ZVA** — AI medical devices.
...
National-specific additions: Data State Inspectorate (DVI) GDPR Article 22 enforcement;
Latvijas Banka financial AI/ML expectations; national equality body
...
1. Latvia competent authority designation for EU AI Act ongoing.
...
- Latvia DPA: see https://edpb.europa.eu/about-edpb/about-edpb/members_en
- EUR-Lex EU AI Act:
  https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689
- Latvia national gazette / official journal for national
