# Cyprus — National AI Framework

How the public corpus aligns with Cyprus's AI regulatory framework
including the EU AI Act (directly applicable), the national AI strategy,
Office of the Commissioner for Personal Data Protection oversight, and sector frameworks.
...
- Cyprus digital transformation framework.

### 3. Data protection layer

- **PDP Law 125(I)/2018** — implements GDPR.
- **Office of the Commissioner for Personal Data Protection** — supervisory authority.
...
- **Central Bank of Cyprus** — financial sector AI; aligned with EBA/EIOPA/ESMA.
- **Pharmaceutical Services** — AI medical devices.

### 6. Equality framework

- **Equal Treatment in Employment Law 58(I)/2004**.
...
National-specific additions: Office of the Commissioner for Personal Data Protection GDPR Article 22 enforcement;
Central Bank of Cyprus financial AI/ML expectations; national equality body
...
1. Cyprus competent authority designation for EU AI Act ongoing.
...
- Cyprus DPA: see https://edpb.europa.eu/about-edpb/about-edpb/members_en
- EUR-Lex EU AI Act:
  https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689
- Cyprus national gazette / official journal for national
