# Romania — National AI Framework

How the public corpus aligns with Romania's AI regulatory framework
including the EU AI Act (directly applicable), the national AI strategy,
ANSPDCP oversight, and sector frameworks.
...
- **National Strategy on AI 2024-2027**.
- Romania digital transformation framework.

### 3. Data protection layer

- **Law 190/2018** — implements GDPR.
...
- **Banca Națională a României (BNR)** — financial sector AI; aligned with EBA/EIOPA/ESMA.
- **ANMDMR** — AI medical devices.

### 6. Equality framework

- **Anti-Discrimination Law 137/2000 + CNCD**.
...
National-specific additions: ANSPDCP GDPR Article 22 enforcement;
Banca Națională a României (BNR) financial AI/ML expectations; national equality body
...
1. Romania competent authority designation for EU AI Act ongoing.
...
- Romania DPA: see https://edpb.europa.eu/about-edpb/about-edpb/members_en
- EUR-Lex EU AI Act:
  https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689
- Romania national gazette / official journal for national
