# Luxembourg — National AI Framework

How the public corpus aligns with Luxembourg's AI regulatory framework
including the EU AI Act (directly applicable), the national AI strategy,
CNPD (Luxembourg) oversight, and sector frameworks.
...
- Luxembourg digital transformation framework.

### 3. Data protection layer

- **Law 1 August 2018** — implements GDPR.
- **CNPD (Luxembourg)** — supervisory authority.
...
- **CSSF** — financial sector AI; aligned with EBA/EIOPA/ESMA.
- **Ministry of Health** — AI medical devices.

### 6. Equality framework

- **Law 28 November 2006 anti-discrimination**.
...
Luxembourg deployments.

National-specific additions: CNPD (Luxembourg) GDPR Article 22 enforcement;
CSSF financial AI/ML expectations; national equality body
...
1. Luxembourg competent authority designation for EU AI Act ongoing.
...
- Luxembourg DPA: see https://edpb.europa.eu/about-edpb/about-edpb/members_en
- EUR-Lex EU AI Act:
  https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689
- Luxembourg national gazette / official journal for national
