# Estonia — National AI Framework

How the public corpus aligns with Estonia's AI regulatory framework
including the EU AI Act (directly applicable), the national AI strategy,
Andmekaitse Inspektsioon (AKI) oversight, and sector frameworks.
...
- **Estonian AI Strategy 2022-2023 (Kratt strategy successor)**.
- Estonia digital transformation framework.

### 3. Data protection layer

- **PDPA 2018** — implements GDPR.
- **Andmekaitse Inspektsioon (AKI)** — supervisory authority.
...
- **Eesti Pank** — financial sector AI; aligned with EBA/EIOPA/ESMA.
- **Ravimiamet** — AI medical devices.
...
National-specific additions: Andmekaitse Inspektsioon (AKI) GDPR Article 22 enforcement;
Eesti Pank financial AI/ML expectations; national equality body
...
1. Estonia competent authority designation for EU AI Act ongoing.
...
- Estonia DPA: see https://edpb.europa.eu/about-edpb/about-edpb/members_en
- EUR-Lex EU AI Act:
  https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689
- Estonia national gazette / official journal for national
