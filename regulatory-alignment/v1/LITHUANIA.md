# Lithuania — National AI Framework

How the public corpus aligns with Lithuania's AI regulatory framework
including the EU AI Act (directly applicable), the national AI strategy,
VDAI (State Data Protection Inspectorate) oversight, and sector frameworks.
...
- **Lithuanian AI Strategy 2025**.
- Lithuania digital transformation framework.

### 3. Data protection layer

- **ADTAĮ** — implements GDPR.
- **VDAI (State Data Protection Inspectorate)** — supervisory authority.
...
- **Lietuvos bankas** — financial sector AI; aligned with EBA/EIOPA/ESMA.
- **VVKT** — AI medical devices.
...
Lithuania deployments.

National-specific additions: VDAI (State Data Protection Inspectorate) GDPR Article 22 enforcement;
Lietuvos bankas financial AI/ML expectations; national equality body
...
1. Lithuania competent authority designation for EU AI Act ongoing.
...
- Lithuania DPA: see https://edpb.europa.eu/about-edpb/about-edpb/members_en
- EUR-Lex EU AI Act:
  https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689
- Lithuania national gazette / official journal for national
