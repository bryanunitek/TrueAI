# Malta — National AI Framework

How the public corpus aligns with Malta's AI regulatory framework
including the EU AI Act (directly applicable), the national AI strategy,
IDPC oversight, and sector frameworks.
...
- **Malta The Ultimate AI Launchpad — A Strategy and Vision 2030**.
- Malta digital transformation framework.

### 3. Data protection layer

- **DP Act Chapter 586** — implements GDPR.
- **IDPC** — supervisory authority.
...
- **Central Bank of Malta** — financial sector AI; aligned with EBA/EIOPA/ESMA.
- **Malta Medicines Authority** — AI medical devices.

### 6. Equality framework

- **Equal Opportunities Act + Equality Act**.
...
National-specific additions: IDPC GDPR Article 22 enforcement;
Central Bank of Malta financial AI/ML expectations; national equality body
...
1. Malta competent authority designation for EU AI Act ongoing.
...
- Malta DPA: see https://edpb.europa.eu/about-edpb/about-edpb/members_en
- EUR-Lex EU AI Act:
  https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689
- Malta national gazette / official journal for national
