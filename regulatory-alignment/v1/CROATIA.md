# Croatia — National AI Framework

How the public corpus aligns with Croatia's AI regulatory framework
including the EU AI Act (directly applicable), the national AI strategy,
AZOP oversight, and sector frameworks.
...
- **Strategy for AI Development 2022-2027**.
- Croatia digital transformation framework.

### 3. Data protection layer

- **Act 42/2018** — implements GDPR.
- **AZOP** — supervisory authority.
...
- **Hrvatska narodna banka (HNB)** — financial sector AI; aligned with EBA/EIOPA/ESMA.
- **HALMED** — AI medical devices.

### 6. Equality framework

- **Anti-Discrimination Act NN 85/08**.
...
National-specific additions: AZOP GDPR Article 22 enforcement;
Hrvatska narodna banka (HNB) financial AI/ML expectations; national equality body
...
1. Croatia competent authority designation for EU AI Act ongoing.
...
- Croatia DPA: see https://edpb.europa.eu/about-edpb/about-edpb/members_en
- EUR-Lex EU AI Act:
  https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689
- Croatia national gazette / official journal for national
