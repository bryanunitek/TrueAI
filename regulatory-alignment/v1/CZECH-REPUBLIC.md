# Czech Republic — National AI Framework

How the public corpus aligns with Czech Republic's AI regulatory framework
including the EU AI Act (directly applicable), the national AI strategy,
ÚOOÚ oversight, and sector frameworks.
...
- **National AI Strategy of the Czech Republic (NAIS 2030)**.
- Czech Republic digital transformation framework.

### 3. Data protection layer

- **Act 110/2019** — implements GDPR.
- **ÚOOÚ** — supervisory authority.
...
- **Czech National Bank (ČNB)** — financial sector AI; aligned with EBA/EIOPA/ESMA.
- **SÚKL** — AI medical devices.

### 6. Equality framework

- **Anti-Discrimination Act 198/2009**.
...
Czech Republic deployments.

National-specific additions: ÚOOÚ GDPR Article 22 enforcement;
Czech National Bank (ČNB) financial AI/ML expectations; national equality body
...
1. Czech Republic competent authority designation for EU AI Act ongoing.
...
- Czech Republic DPA: see https://edpb.europa.eu/about-edpb/about-edpb/members_en
- EUR-Lex EU AI Act:
  https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689
- Czech Republic national gazette / official journal for national
