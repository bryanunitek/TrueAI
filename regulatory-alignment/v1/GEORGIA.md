# Georgia — National AI Framework

How the public corpus aligns with Georgia's AI regulatory framework
including EU candidate alignment, National AI Strategy 2024-2030, Personal Data Protection Service oversight, and sector frameworks.

## The law

### 1. National AI strategy

- **Georgia National AI Strategy 2024-2030 (Ministry of Innovation and Technology)**.

### 2. Data protection layer

- **Law on Personal Data Protection (2014, as substantially amended by Organic Law 2023)**.
- **Personal Data Protection Service** — supervisory authority.

### 3. Cybersecurity layer

- **Law on Information Security 2012; updated cybersecurity framework**.
- **CERT.GOV.GE**.

### 4. Sector-specific frameworks

- **National Bank of Georgia (NBG)** — financial sector AI.
- **Regulation Agency for Medical Activities** — AI medical devices.
...
1. Georgia has no AI-specific horizontal law yet (strategy/policy
...
- Personal Data Protection Service: https://personaldata.ge/
- Law on PDP 2014: https://matsne.gov.ge/
