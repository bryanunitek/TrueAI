# North Macedonia — National AI Framework

How the public corpus aligns with North Macedonia's AI regulatory framework
including EU candidate alignment, National AI Strategy (NAIS 2023-2027), Law on Personal Data Protection, and sector frameworks.

## The law

### 1. National AI strategy

- **National AI Strategy 2023-2027 (NAIS)**.

### 2. Data protection layer

- **Law on Personal Data Protection (Official Gazette 42/20)**.
- **Personal Data Protection Agency** — supervisory authority.

### 3. Cybersecurity layer

- **Law on Network and Information Systems Security**.
- **MKD-CIRT**.

### 4. Sector-specific frameworks

- **Narodna banka na Republika Severna Makedonija (NBRSM)** — financial sector AI.
- **Agency for Medicines and Medical Devices (MALMED)** — AI medical devices.
...
1. North Macedonia has no AI-specific horizontal law yet (strategy/policy
...
- Personal Data Protection Agency: https://azlp.mk/
- Law on PDP: https://www.slvesnik.com.mk/
