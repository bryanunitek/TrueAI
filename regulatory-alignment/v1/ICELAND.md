# Iceland — National AI Framework

How the public corpus aligns with Iceland's AI regulatory framework
including EEA-applicable EU AI Act, Personuvernd, and sector frameworks.

## The law

### 1. National AI strategy

- **AI Strategy 2021 (Stefnumótun um gervigreind)**.

### 2. Data protection layer

- **Act on Data Protection and the Processing of Personal Data No. 90/2018**.
- **Persónuvernd** — supervisory authority.

### 3. Cybersecurity layer

- **Cybersecurity Strategy 2022-2037**.
- **CERT-IS**.

### 4. Sector-specific frameworks

- **Seðlabanki Íslands (Central Bank of Iceland)** — financial sector AI.
- **Lyfjastofnun (Icelandic Medicines Agency)** — AI medical devices.

### 5. Equality framework

- **Equal Status Act No. 150/2020**.
...
1. Iceland has no AI-specific horizontal law yet (strategy/policy
...
- Persónuvernd: https://www.personuvernd.is/
- Act 90/2018: https://www.althingi.is/lagas/nuna/2018090.html
- EU AI Act via EEA: https://www.efta.int/eea-lex
