# Albania — National AI Framework

How the public corpus aligns with Albania's AI regulatory framework
including EU candidate alignment, draft Strategy for AI 2025-2030, Law on Personal Data Protection, and sector frameworks.

## The law

### 1. National AI strategy

- **Draft National Strategy for AI 2025-2030 (Ministry of Education and Sport / NAIS)**.

### 2. Data protection layer

- **Law 9887/2008 on Personal Data Protection (as amended); new PDPL aligned with GDPR pending**.
- **Office of the Information and Data Protection Commissioner (IDP)** — supervisory authority.
...
- **Bank of Albania (BSH)** — financial sector AI.
- **Albanian National Agency for Medicines and Medical Devices** — AI medical devices.

### 5. Equality framework

- **Law on Protection from Discrimination + Commissioner for Protection from Discrimination**.
...
1. Albania has no AI-specific horizontal law yet (strategy/policy
...
- IDP: https://www.idp.al/
- Law 9887/2008: https://www.idp.al/
