# Serbia — National AI Framework

How the public corpus aligns with Serbia's AI regulatory framework
including EU candidate alignment, Strategy AI 2020-2025, the Commissioner for Information of Public Importance and Personal Data Protection, and sector frameworks.

## The law

### 1. National AI strategy

- **Strategy for the Development of AI in Serbia 2020-2025**.

### 2. Data protection layer

- **Law on Personal Data Protection 2018 (87/2018)**.
- **Commissioner for Information of Public Importance and Personal Data Protection** — supervisory authority.
...
- **Narodna banka Srbije (NBS)** — financial sector AI.
- **Agency for Medicines and Medical Devices (ALIMS)** — AI medical devices.

### 5. Equality framework

- **Law on the Prohibition of Discrimination + Commissioner for Protection of Equality**.
...
1. Serbia has no AI-specific horizontal law yet (strategy/policy
...
- Commissioner: https://www.poverenik.rs/
- Law on PDP 87/2018: https://www.paragraf.rs/
- AI Strategy: https://www.srbija.gov.rs/
