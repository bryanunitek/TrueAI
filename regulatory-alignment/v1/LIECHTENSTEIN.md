# Liechtenstein — National AI Framework

How the public corpus aligns with Liechtenstein's AI regulatory framework
including EEA-applicable EU AI Act, Datenschutzstelle, and sector frameworks.

## The law

### 1. National AI strategy

- **Liechtenstein Digital Strategy**.

### 2. Data protection layer

- **Datenschutzgesetz (DSG) 2019**.
- **Datenschutzstelle (DSS)** — supervisory authority.

### 3. Cybersecurity layer

- **NIS-equivalent transposition via EEA**.
- **National CERT**.

### 4. Sector-specific frameworks

- **FMA Liechtenstein** — financial sector AI.
- **Amt für Gesundheit** — AI medical devices.
...
1. Liechtenstein has no AI-specific horizontal law yet (strategy/policy
...
- DSS: https://www.datenschutzstelle.li/
- DSG 2019: https://www.gesetze.li/
- FMA: https://www.fma-li.li/
