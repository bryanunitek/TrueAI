# Kazakhstan — National AI Framework

How the public corpus aligns with Kazakhstan's AI regulatory framework
including the Concept on AI Development 2024-2029, Personal Data Protection Law, Astana International Financial Centre (AIFC) AI activities, and sector frameworks.

## The law

### 1. National AI strategy

- **Concept on AI Development of the Republic of Kazakhstan for 2024-2029; Digital Kazakhstan State Programme**.

### 2. Data protection layer

- **Law on Personal Data and Their Protection (Law 94-V of 2013, as substantially amended 2020, 2024)**.
- **Personal Data Protection Agency under Ministry of Digital Development** — supervisory authority.
...
- **National Bank of the Republic of Kazakhstan (NBK)** — financial sector AI.
- **Committee on Medical and Pharmaceutical Control** — AI medical devices.

### 5. Equality framework

- **Law on State Guarantees of Equal Rights and Equal Opportunities**.
...
1. Kazakhstan has no AI-specific horizontal law yet (strategy/policy
...
- Ministry of Digital Development: https://www.gov.kz/memleket/entities/mdai
- Law on PDP 94-V: https://adilet.zan.kz/
- AIFC: https://aifc.kz/
