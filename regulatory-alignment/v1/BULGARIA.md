# Bulgaria — National AI Framework

How the public corpus aligns with Bulgaria's AI regulatory framework
including the EU AI Act (directly applicable), the national AI strategy,
Commission for Personal Data Protection (KZLD) oversight, and sector frameworks.
...
- **Concept for AI Development 2020-2030**.
- Bulgaria digital transformation framework.

### 3. Data protection layer

- **PDPA** — implements GDPR.
- **Commission for Personal Data Protection (KZLD)** — supervisory authority.
...
- **Bulgarian National Bank (BNB)** — financial sector AI; aligned with EBA/EIOPA/ESMA.
- **BDA** — AI medical devices.
...
Bulgaria deployments.

National-specific additions: Commission for Personal Data Protection (KZLD) GDPR Article 22 enforcement;
Bulgarian National Bank (BNB) financial AI/ML expectations; national equality body
...
1. Bulgaria competent authority designation for EU AI Act ongoing.
...
- Bulgaria DPA: see https://edpb.europa.eu/about-edpb/about-edpb/members_en
- EUR-Lex EU AI Act:
  https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689
- Bulgaria national gazette / official journal for national
