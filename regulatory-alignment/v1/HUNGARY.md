# Hungary — National AI Framework

How the public corpus aligns with Hungary's AI regulatory framework
including the EU AI Act (directly applicable), the national AI strategy,
NAIH oversight, and sector frameworks.
...
- **Hungary AI Strategy 2020-2030**.
- Hungary digital transformation framework.

### 3. Data protection layer

- **Act CXII of 2011** — implements GDPR.
- **NAIH** — supervisory authority.
...
- **Magyar Nemzeti Bank (MNB)** — financial sector AI; aligned with EBA/EIOPA/ESMA.
- **OGYÉI** — AI medical devices.

### 6. Equality framework

- **Act CXXV of 2003 Equal Treatment**.
...
National-specific additions: NAIH GDPR Article 22 enforcement;
Magyar Nemzeti Bank (MNB) financial AI/ML expectations; national equality body
...
1. Hungary competent authority designation for EU AI Act ongoing.
...
- Hungary DPA: see https://edpb.europa.eu/about-edpb/about-edpb/members_en
- EUR-Lex EU AI Act:
  https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689
- Hungary national gazette / official journal for national
