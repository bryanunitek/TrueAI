# Slovakia — National AI Framework

How the public corpus aligns with Slovakia's AI regulatory framework
including the EU AI Act (directly applicable), the national AI strategy,
Úrad na ochranu osobných údajov oversight, and sector frameworks.
...
- **Action Plan Digital Transformation 2019-2022 with AI elements**.
- Slovakia digital transformation framework.

### 3. Data protection layer

- **Act 18/2018** — implements GDPR.
- **Úrad na ochranu osobných údajov** — supervisory authority.
...
- **Národná banka Slovenska (NBS)** — financial sector AI; aligned with EBA/EIOPA/ESMA.
- **ŠÚKL** — AI medical devices.
...
Slovakia deployments.

National-specific additions: Úrad na ochranu osobných údajov GDPR Article 22 enforcement;
Národná banka Slovenska (NBS) financial AI/ML expectations; national equality body
...
1. Slovakia competent authority designation for EU AI Act ongoing.
...
- Slovakia DPA: see https://edpb.europa.eu/about-edpb/about-edpb/members_en
- EUR-Lex EU AI Act:
  https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689
- Slovakia national gazette / official journal for national
