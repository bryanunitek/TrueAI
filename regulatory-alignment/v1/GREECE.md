# Greece — National AI Framework

How the public corpus aligns with Greece's AI regulatory framework
including the EU AI Act (directly applicable), the national AI strategy,
HDPA (Hellenic DPA) oversight, and sector frameworks.
...
- **National Strategy for AI 2024**.
- Greece digital transformation framework.

### 3. Data protection layer

- **Law 4624/2019** — implements GDPR.
- **HDPA (Hellenic DPA)** — supervisory authority.
...
- **Bank of Greece** — financial sector AI; aligned with EBA/EIOPA/ESMA.
- **EOF** — AI medical devices.

### 6. Equality framework

- **Law 4443/2016 anti-discrimination**.
...
National-specific additions: HDPA (Hellenic DPA) GDPR Article 22 enforcement;
Bank of Greece financial AI/ML expectations; national equality body
...
1. Greece competent authority designation for EU AI Act ongoing.
...
- Greece DPA: see https://edpb.europa.eu/about-edpb/about-edpb/members_en
- EUR-Lex EU AI Act:
  https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689
- Greece national gazette / official journal for national
