...
| [`GO-TOKEN.md`](GO-TOKEN.md) | The literal token **`GO~`** at end of message is the only valid resumption authorisation after pause / interruption; soft signals never authorise (§5.10) |
